...
namespace EzyTaskin.Data.Migrations
{
    ...
    [Migration("20250513111055_AddPaymentCommandAmount")]
    partial class AddPaymentCommandAmount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EzyTaskin.Data.Db.PaymentCommand", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EzyTaskin.Data.Db.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EzyTaskin.Data.Db.Consumer", b =>
                {
                    b.HasOne("EzyTaskin.Data.Account", "Account")
                        .WithOne()
                        .HasForeignKey("EzyTaskin.Data.Db.Consumer", "AccountId")
            ...
            modelBuilder.Entity("EzyTaskin.Data.Db.PaymentCommand", b =>
                {
                    b.HasOne("EzyTaskin.Data.Db.PaymentMethod", "From")
                        .WithMany()
                        .HasForeignKey("FromId");

                    b.HasOne("EzyTaskin.Data.Db.PaymentMethod", "To")
                        .WithMany()
                        .HasForeignKey("ToId");
            ...
            modelBuilder.Entity("EzyTaskin.Data.Db.Provider", b =>
                {
                    b.HasOne("EzyTaskin.Data.Account", "Account")
                        .WithOne()
                        .HasForeignKey("EzyTaskin.Data.Db.Provider", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EzyTaskin.Data.Db.Request", b =>
                {
                    ...
                    b.HasOne("EzyTaskin.Data.Db.Offer", "Selected")
                        .WithMany()
            ...
            modelBuilder.Entity("EzyTaskin.Data.Db.Review", b =>
                {
                    b.HasOne("EzyTaskin.Data.Db.Request", "Request")
                        .WithOne()
                        .HasForeignKey("EzyTaskin.Data.Db.Review", "RequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
